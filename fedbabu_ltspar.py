...
if __name__ == '__main__':
    ...
    for rnd in tqdm(range(args.rounds)):
        ...
        for i in range(args.num_users):
            ...
            # print('copy sucess')
            acc_local, f1_macro, f1_weighted, acc_3shot_local = localtest_villina(copy.deepcopy(model).to(args.device), dataset_test, dataset_class = datasetObj, idxs=dict_localtest[i], user_id = i)
        ...
        # torch.save(model, "./output/fedbabu_spar06_zoom/netglob_" + str(rnd) + ".pth")
        # for i in range(args.num_users):
